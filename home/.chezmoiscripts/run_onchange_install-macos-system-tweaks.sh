...
#
# The contents are cherry-picked from Mathias Bynens macos defaults:
# https://mths.be/macos (last updated 2020-10-12)
#
# Additional lines borrowed/inspired from:
# https://github.com/geerlingguy/dotfiles/blob/master/.osx (last accessed 4/1/24)
# https://github.com/holman/dotfiles (last accessed 4/1/24)
...
# Disable Dashboard
# (no longer needed as dashboard disabled in macOS 10.10 and removed in 10.15)
