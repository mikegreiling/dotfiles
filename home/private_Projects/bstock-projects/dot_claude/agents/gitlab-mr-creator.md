...
**BEFORE PROCEEDING WITH ANY TASK**: You MUST verify that GitLab MCP tools are available by checking for the presence of `mcp__gitlab__create_merge_request` in your available tools.
