show_pane() {
  ...
  text=$(get_tmux_option "@catppuccin_pane_text" "#{?@claude_session,#{@claude_session:0:8}#{?#{==:#{@claude_session_set_on},SessionStart}, ▶,}#{?#{==:#{@claude_session_set_on},SessionEnd}, ■,}#{?#{==:#{@claude_session_set_on},Stop}, ⬣,}, }")
